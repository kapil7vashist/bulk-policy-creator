...
for(let i=0;i<data.length;i++){    
    ...
    let newRecord = [record.Email,riskStartDate,freshName[0],gender,record.Mobile,record.Email,freshName[1],record.City,state,record.Pincode,record["Manufacturing Year"],record["Vehicle Registration No."],record["Vehicle Manufacturer"],record.Model,record.Variant,record["Engine No."],record["Chassis No."],nomineeDetail[0],nomineeDetail[1],'Male',nomineeDetail[2],record.PLAN,'CPA + RSA + AHDC + DOC','Yes',dealerID,timestamp];
